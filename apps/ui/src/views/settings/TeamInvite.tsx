...
export default function TeamInvite({ member, onMember, ...props }: TeamInviteProps) {
    ...
    const mailto = (email: string) => {
        const text = `Hello!\n\nI have just added you to the project ${project.name} on Quoting Fast. To get started and setup your account, please click the link below:\n\n${window.location.origin}`
        return `mailto:${email}?subject=Quoting%20Fast%20Project&body=${encodeURI(text)}`
    }
